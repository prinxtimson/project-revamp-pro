    ...
    useEffect(() => {
        if (dominantSpeaker !== null) {
            ...
            setOrderedParticipants(() => {
                const newParticipantsArray = orderedParticipants;
                ...
                if (
                    ...
                    const sortedFirstPageParticipants =
                        firstPageParticipants?.sort(
                            (a, b) =>
        ...
        return () => {
            setOrderedParticipants(null);
        };
    }, [
        dominantSpeaker,
        maxGalleryViewParticipants,
        isMobileGalleryViewActive,
    ]);
